...
* and from the web.
* Note that this class does not know how to read general csv files, but only very simple ones.
*
* Also, this class strongly assumes that the file (or URL)
* is actually a CSV file. It will read any file and try
...
public class ReadCSV implements Iterable<String[]> {
    ...
    */
    public ReadCSV(String name, int maxSplit) throws IOException {
        ...
        // check that the thing can be opened. Does not guarantee openable at use, but still helpful
